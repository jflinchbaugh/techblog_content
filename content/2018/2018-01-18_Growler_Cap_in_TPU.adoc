title=2018-01-13 Full Dance Floor at 80s/90s Night
date=2018-01-13
type=post
status=published
tags=Photo,Make365
...
One of the first things we designed
...
I've printed multiple iterations of it,
...
and maybe some TPU for the seal.
