...
I made my little battery figure I had previously been designing.
The openscad
https://github.com/jflinchbaugh/objects/blob/master/action_battery.scad[code]
is available.
